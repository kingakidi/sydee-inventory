<?php 
            ...
            $revenueQuery = mysqli_query($conn, "SELECT * FROM `revenue` WHERE branch_id = $branchId AND CAST( date AS Date ) = CAST( NOW() AS Date )  ORDER BY date DESC");           
            if (!$revenueQuery) {
            ...
            $eQuery = mysqli_query($conn, "SELECT * FROM expenses WHERE branch_id=$branchId AND CAST( date AS Date ) = CAST( NOW() AS Date )  ORDER BY date DESC");
            ...
            if (!$eQuery) {
                ...
                while($row = mysqli_fetch_assoc($eQuery)){
                    ...
                    $userFullname = "Aka'aba Musa Akidi";
